...
const Icons = {
  ...
  GitBranch: (p) => Icon({
    ...p, path: [
      h('line', { key: 1, x1: "6", x2: "6", y1: "3", y2: "15" }),
      h('circle', { key: 2, cx: "18", cy: "6", r: "3" }),
      h('circle', { key: 3, cx: "6", cy: "18", r: "3" }),
      h('path', { key: 4, d: "M18 9a9 9 0 0 1-9 9" })
    ]
  }),
  ...
  EyeOff: (p) => Icon({
    ...p, path: [
      ...
      h('line', { key: 4, x1: "2", x2: "22", y1: "2", y2: "22" })
    ]
  }),
  ...
  Info: (p) => Icon({
    ...p, path: [
      h('circle', { key: 1, cx: "12", cy: "12", r: "10" }),
      h('line', { key: 2, x1: "12", x2: "12", y1: "16", y2: "12" }),
      h('line', { key: 3, x1: "12", x2: "12.01", y1: "8", y2: "8" })
    ]
  }),
